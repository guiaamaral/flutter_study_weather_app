...
Future<WeatherData> fetchWeatherByCity(String city, String country) async {
  final response = await http.get(Uri.parse(
      'https://api.openweathermap.org/data/2.5/weather?lang=pt_br&units=metric&q=$city,$country&appid=$apiKey'));
